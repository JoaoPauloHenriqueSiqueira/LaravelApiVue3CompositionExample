    ...
    <form class="space-y-6" @submit.prevent="saveProduct">
        <div class="space-y-4 rounded-md shadow-sm">
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" name="price" id="price" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" v-model="form.price">
                </div>
            </div>
